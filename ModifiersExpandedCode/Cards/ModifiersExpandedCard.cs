...
namespace ModifiersExpanded.ModifiersExpandedCode.Cards;
...
/// </summary>
public abstract class ModifiersExpandedCard(int cost, CardType type, CardRarity rarity, TargetType target) :
